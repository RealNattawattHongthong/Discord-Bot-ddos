...
bot = commands.Bot(command_prefix = "$", description = "DDOS Discord made by OREO YOUNG MAN")
...
@bot.event
async def on_ready():
    activity = discord.Game(name="$help | Powered By OREO YOUNG MAN Brains", type=3)
...
async def methods(ctx):
    ...
    embed = discord.Embed(title="Methods", description="Bot Discord DDOS made by OREO YOUNG MAN.")
...
async def showcommand(ctx):
    embed = discord.Embed(title="Info : ", description="Bot Discord DDOS made by OREO YOUNG MAN.")
...
async def status(ctx):
    embed = discord.Embed(title="Status of attack server : ", description="Bot Discord DDOS made by OREO YOUNG MAN.")
